...
import com.kevinboone.android_simple_eq.EqualazerActivity;
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_equalazer:
                Intent equalazer = new Intent(this, EqualazerActivity.class);
                startActivity(equalazer);
                return true;
